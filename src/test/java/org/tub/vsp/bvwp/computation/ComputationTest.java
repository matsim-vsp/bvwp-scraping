...
//        {
//            double nkv = calculateNkv(new Modifications( 145., 0.), amounts, benefits, baukosten );
//            Assertions.assertEquals(1.938378, nkv, 0.001);
//        }
//        {
//            double nkv = calculateNkv(new Modifications( 5. * 145., 0.), amounts, benefits, baukosten );
